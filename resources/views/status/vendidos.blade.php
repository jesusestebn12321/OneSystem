...
<div class="row"> 
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="box">
			<div class="col-md-7">
				<div class="x_title">
					<h2><i class="fa fa-inbox"></i>Productos Vendidos</h2>
					...
					<table  class="table table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="col-md-2">Fecha de Venta</th>
								...
								@if($productos->act == 2)
									@if($productos->user_id == Auth::user()->id)	
										...
										<tr>
											...
											<td>{{$productos->productoImagen->producto->updated_at}}</td>
											<td>@if($productos->act==2) <i class="badge">Comprados</i>@endif</td>
											<td>
												<div class="col-md-6 col-xs-6">
													...
													<a href="{{route('manageArticulo-activar', $productos->id)}}" id="activar" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="Activar"><i class="fa fa-play"></i></a>
