    ...
    <div class="container">
        <div class="row py-4 d-flex align-items-center">
          <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
            <h4 class="mb-0 app-h4">Vende Compra Rapido y Facil!</h4>
          </div>
          <div class="col-md-6 col-lg-7 text-center text-md-right">
            ...
            <a class="tw-ic">
              <i class="fa fa-twitter  mr-4" style="color:white"> </i>
            </a>
            <a class="gplus-ic">
              <i class="fa fa-google-plus  mr-4" style="color:white"> </i>
            </a>
            <a class="li-ic">
...
<div class="footer-copyright text-center py-3" style="background: #ccc">© 2018 Copyright:
