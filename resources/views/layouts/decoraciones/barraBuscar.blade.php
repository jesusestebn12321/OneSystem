<div class="hidden-sm hidden-xs">
	<form  class="input-group margin" style="width:500px;height:50px;" action="{{route('manageBuscar')}}">
		<span class="input-group-btn"> 
			<a href="#" id="categoria" class="dropdown-toggle btn btn-flat text-gray"  style="height:100%;border-right:2px solid #cccc;border-radius:4px 0px 0px 4px;background:white;" >Todas las Categorias...<i class="fa fa-chevron-down"></i></a>
		</span>
